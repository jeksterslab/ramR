...
`Eq*` functions in the `ramR` package require an input 
...
## Symmetric - error variances
  epsilon[1] with epsilon[1] theta[y1]
  epsilon[2] with epsilon[2] theta[y2]
  epsilon[3] with epsilon[3] theta[y3]
  epsilon[4] with epsilon[4] theta[y4]
  epsilon[5] with epsilon[5] theta[y5]
  epsilon[6] with epsilon[6] theta[y6]
# factors
## variances and covariances
  eta[1] with eta[1] psi[11]
  eta[1] with eta[2] psi[12]
  eta[2] with eta[2] psi[22]
## means
  eta[1] on 1 alpha[1]
  eta[2] on 1 alpha[2]
"
