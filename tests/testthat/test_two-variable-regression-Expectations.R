...
#'
#+ symbolic
Symbolic <- ramR::Expectations(Ryacas::ysym(A), Ryacas::ysym(S), u, Ryacas::ysym(Filter))
...
ramR::Expectations(Ryacas::ysym(A), S, u = NULL, Filter = NULL, str = TRUE, ysym = FALSE, simplify = TRUE)
ramR::Expectations(Ryacas::ysym(A), S, u = NULL, Filter = NULL, str = TRUE, tex = TRUE, simplify = TRUE)
ExpectationsTex <- ramR::Expectations(Ryacas::ysym(A), S, u, Filter, str = TRUE, tex = TRUE, simplify = TRUE)
#'
#+ symbolic_u_null
SymbolicuNull <- ramR::Expectations(Ryacas::ysym(A), S, u = NULL, Filter)
...
SymbolicuNullFilter <- round(Ryacas::as_r(SymbolicuNull$Filter), digits = 4)
...
SymbolicuNullExpr <- ramR::Expectations(Ryacas::ysym(A), S, u = NULL, Filter, str = FALSE, simplify = TRUE)
SymbolicuNullExprC <- round(Ryacas::as_r(SymbolicuNullExpr$C), digits = 4)
...
SymbolicFilterNull <- ramR::Expectations(Ryacas::ysym(A), S, u, Filter = NULL)
SymbolicFilterNullA <- round(Ryacas::as_r(SymbolicFilterNull$A), digits = 4)
SymbolicFilterNullS <- round(Ryacas::as_r(SymbolicFilterNull$S), digits = 4)
SymbolicFilterNullu <- round(Ryacas::as_r(SymbolicFilterNull$u), digits = 4)
SymbolicFilterNullFilter <- round(Ryacas::as_r(SymbolicFilterNull$Filter), digits = 4)
SymbolicFilterNullC <- round(Ryacas::as_r(SymbolicFilterNull$C), digits = 4)
SymbolicFilterNullM <- round(Ryacas::as_r(SymbolicFilterNull$M), digits = 4)
SymbolicFilterNullv <- round(Ryacas::as_r(SymbolicFilterNull$v), digits = 4)
SymbolicFilterNullg <- round(Ryacas::as_r(SymbolicFilterNull$g), digits = 4)
SymbolicFilterNullExpr <- ramR::Expectations(Ryacas::ysym(A), S, u, Filter = NULL, str = FALSE, simplify = TRUE)
SymbolicFilterNullExprC <- round(Ryacas::as_r(SymbolicFilterNullExpr$C), digits = 4)
SymbolicFilterNullExprM <- round(Ryacas::as_r(SymbolicFilterNullExpr$M), digits = 4)
SymbolicFilterNullExprv <- round(Ryacas::as_r(SymbolicFilterNullExpr$v), digits = 4)
SymbolicFilterNullExprg <- round(Ryacas::as_r(SymbolicFilterNullExpr$g), digits = 4)
#'
#+ tex, results = "asis"
cat(
  "\\begin{align*}",
